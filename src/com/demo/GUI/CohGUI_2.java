...
public class CohGUI_2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CohGUI_2 frame = new CohGUI_2(new user());
...
/*Content*/		
		/*Date1*/
		JLabel lblDate1 = new JLabel("Tue.");
