...
public class VidGUI_2 extends JFrame {
	...
	public VidGUI_2() {
		...
		/*Button: HIIT*/
		JButton btnNewButton_1 = new JButton("HIIT");
		...
		/*Button: Yoga*/
		JButton btnNewButton_2 = new JButton("Yoga");
		...
		lblNewLabel3.setBounds(0, 135, 100, 50);
		contentPane.add(lblNewLabel3);
		
		/*Button: Strength*/
		JButton btnNewButton_3 = new JButton("Strength");
		btnNewButton_3.setForeground(Color.WHITE);
		btnNewButton_3.setFont(new Font("Times New Roman", Font.BOLD, 18));
		btnNewButton_3.setBounds(3, 200, 90, 20);
		//set transparent
		...
		lblNewLabel.setBounds(210, 0, 90, 90);
