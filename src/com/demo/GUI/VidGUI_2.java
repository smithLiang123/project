...
public class VidGUI_2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VidGUI_2 frame = new VidGUI_2(new user());
...
/*MENU BAR END*/
		...
		lblBtnSha.setBounds(0, 135, 100, 50);
		...
		/*Vid1*/
		JLabel lblVid1 = new JLabel(new ImageIcon("img/cover-yoga-01.jpg"));
		lblVid1.setBounds(120, 115, 320, 180);
		contentPane.add(lblVid1);
		//播放按钮
		JButton btnVid1 = new JButton("<html>"
										+ "<center>10 minute Simple Yoga Flow for All Levels | Sarah Beth Yoga</center>"
									+ "</html>");
		...
		btnVid1.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
				frame = new Window(u);
				frame.setVisible(true);
				frame.getMediaPlayer().playMedia("vid/yoga-01.mp4"); // 直接播放视屏，参数是视屏文件的绝对路径
				//关闭旧窗口
		        dispose();
		    }
		});
		...
		/*Vid2*/
		JLabel lblVid2 = new JLabel(new ImageIcon("img/cover-yoga-02.jpg"));
		lblVid2.setBounds(500, 115, 320, 180);
		contentPane.add(lblVid2);
		//播放按钮
		JButton btnVid2 = new JButton("<html>"
										+ "<center>Morning Yoga Mobility Routine in 10 Minutes | Yoga With Tim</center>"
									+ "</html>");
		...
		btnVid2.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
				frame = new Window(u);
				frame.setVisible(true);
				frame.getMediaPlayer().playMedia("vid/yoga-02.mp4"); // 直接播放视屏，参数是视屏文件的绝对路径
				//关闭旧窗口
		        dispose();
		    }
		});
