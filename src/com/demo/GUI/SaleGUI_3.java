...
public class SaleGUI_3 extends JFrame {
	...
	public SaleGUI_3() {
		...
		/*Button: Class1*/
		JButton btnNewButton_1 = new JButton("Class1");
		...
		/*Button: Class2*/
		JButton btnNewButton_2 = new JButton("Class2");
		...
		/*Button: Class3*/
		JButton btnNewButton_3 = new JButton("Class3");
		...
		lblNewLabel.setBounds(305, 0, 90, 90);
