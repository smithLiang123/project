...
public class CohGUI_3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CohGUI_3 frame = new CohGUI_3(new user());
...
/*Content*/		
		/*Date1*/
		JLabel lblDate1 = new JLabel("Fri.");
		...
		/*Date2*/
		JLabel lblDate2 = new JLabel("Sat.");
		...
		/*初始化显示教练的预约时间表*/
		try {
			apResult = ap.showInfo("Risa","coh3",u.getName());
		} catch (Exception e1) {
