...
public class VidGUI_3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VidGUI_3 frame = new VidGUI_3(new user());
...
/*MENU BAR END*/
		...
		lblBtnSha.setBounds(0, 185, 100, 50);
		contentPane.add(lblBtnSha);
		
		/*Vid1*/
		JLabel lblVid1 = new JLabel(new ImageIcon("img/cover-strength-01.jpg"));
		lblVid1.setBounds(120, 115, 320, 180);
		contentPane.add(lblVid1);
		//播放按钮
		JButton btnVid1 = new JButton("<html>"
										+ "<center>10 Minute FULL BODY Strength Training Workout With Weights (GET TONED)</center>"
									+ "</html>");
		...
		btnVid1.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
				frame = new Window(u);
				frame.setVisible(true);
				frame.getMediaPlayer().playMedia("vid/strength-01.mp4"); // 直接播放视屏，参数是视屏文件的绝对路径
				//关闭旧窗口
		        dispose();
		    }
		});
		...
		/*Vid2*/
		JLabel lblVid2 = new JLabel(new ImageIcon("img/cover-strength-02.jpg"));
		lblVid2.setBounds(500, 115, 320, 180);
		contentPane.add(lblVid2);
		//播放按钮
		JButton btnVid2 = new JButton("<html>"
										+ "<center>No Repeat Dumbbell Workout -10 MINS | BEGINNER FRIENDLY</center>"
									+ "</html>");
		...
		btnVid2.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
				frame = new Window(u);
				frame.setVisible(true);
				frame.getMediaPlayer().playMedia("vid/strength-02.mp4"); // 直接播放视屏，参数是视屏文件的绝对路径
				//关闭旧窗口
		        dispose();
		    }
		});
